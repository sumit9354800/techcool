      ...
      <Container>
        <div className="grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="leading-7 text-slate-400">
              Professional LED TV repair, CCTV installation and AC services with
              experienced technicians, same-day doorstep support and transparent
              pricing.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-3 text-slate-400">
                ...
                <span className="break-all">mytechycoolservice@gmail.com</span>
              </div>
        ...
        <div className="border-t border-slate-800 py-6">
          <div className="flex flex-col items-center justify-between gap-3 text-center text-sm text-slate-500 md:flex-row">
            <p>© {currentYear} MRTECHYCOOL. All rights reserved.</p>
